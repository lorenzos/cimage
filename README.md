...
| `ff, fill-to-fit`  | Set together with both `h` & `w` to shrink the image to dimensions, filling the rest of the image with specified color, for example `fill-to-fit=ffcc33` for sky-blue. |
